...
export const metadata: Metadata = {
  title: 'Kit solaire balcon 2026 : comparatif et calculateur gratuit',
  description:
    'Guide ind\u00e9pendant des kits solaires pour balcon. Comparez Sunology, Beem, Zendure, EcoFlow. Calculez vos \u00e9conomies r\u00e9elles en 30 secondes.',
};
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <Parallax speed={0.15} className="absolute top-20 right-[10%] pointer-events-none">
          <div className="w-64 h-64 rounded-full bg-amber/5 blur-3xl float float-delay-1" />
        </Parallax>
      ...
      <section className="section-padding bg-charcoal text-cream relative overflow-hidden">
        <Parallax speed={0.12} className="absolute top-0 right-0 pointer-events-none">
          <div className="w-96 h-96 rounded-full bg-amber/5 blur-3xl float" />
        </Parallax>
