...
const faqData = [
  ...
  { question: 'Les rallonges standard fonctionnent-elles ?', answer: 'Oui, mais si votre panneau est en exterieur et la prise a l\'interieur, prenez une rallonge etanche IP44 minimum. Eau et électricité ne font pas bon menage. Comptez 15-25EUR pour une rallonge etanche de 5m.' },
  ...
  { question: 'Comment suivre ma production solaire sans investir ?', answer: 'La plupart des kits Sunology et Beem incluent une application gratuite avec suivi via le micro-onduleur Wi-Fi. Pour aller plus loin, une prise connectee Tapo permet un suivi encore plus fin. Inutile d\'investir dans du matériel pro.' },
