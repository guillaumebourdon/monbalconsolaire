...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // Guides
    { url: `${BASE_URL}/guide/checklist-avant-achat-kit-solaire`, lastModified: '2026-08-07', changeFrequency: 'monthly', priority: 0.8 },
    ...
    // Blog
    { url: `${BASE_URL}/blog/multi-panneaux-serie-parallele`, lastModified: '2026-09-25', changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/blog/panneau-solaire-location-meublee-airbnb`, lastModified: '2026-09-22', changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/blog/proteger-panneau-solaire-oiseaux-intemperies`, lastModified: '2026-08-28', changeFrequency: 'monthly', priority: 0.7 },
