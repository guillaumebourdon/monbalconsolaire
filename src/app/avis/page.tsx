...
const comingSoon = [
  ...
  { title: 'Beem Kit 300W : avis et test complet', desc: 'L\'entrée de gamme à 299\u20ac. Idéal pour tester le solaire.' },
  ...
  return (
    <section className="section-padding">
      <div className="container-brand max-w-4xl">
        ...
        <p className="text-charcoal-light text-lg mb-10 max-w-2xl">Des avis détaillés, sourcés et honnêtes sur les kits solaires plug-and-play les plus populaires en France.</p>
