...
export const SEARCH_INDEX: SearchResult[] = [
  ...
  // ─── Comparatifs ───
  { title: 'Sunology PLAY 2 vs Beem On 500 Wc : le match 2026', description: 'Comparatif 12 crit\u00e8res : prix, ROI, installation, garantie. PLAY 2 (599\u20ac) vs Beem On 500 Wc (429\u20ac). Quel kit choisir ?', url: '/comparatif/sunology-play2-vs-beem-on-500w', category: 'Comparatif', badge: 'Nouveau' },
