...
export const SEARCH_INDEX: SearchResult[] = [
  ...
  { title: 'Linky et panneau solaire : injection, index, surplus', description: 'Que voit le Linky avec un kit solaire ? Index soutirage vs injection, mythe du compteur à l\'envers, surplus gratuit EDF, CACSI obligatoire.', url: '/blog/linky-panneau-solaire-injection', category: 'Blog', badge: 'Comprendre' },
  ...
  { title: 'Facture EDF avec un kit solaire balcon', description: 'Ce qui change sur votre facture, comment mesurer vos \u00e9conomies r\u00e9elles, r\u00f4le du Linky et surplus gratuit.', url: '/blog/facture-edf-kit-solaire', category: 'Blog', badge: 'Comprendre' },
  { title: 'Panneau solaire et canicule : impact production', description: 'Coefficient de temp\u00e9rature, pertes chiffr\u00e9es, PERC vs TOPCon/HJT en \u00e9t\u00e9.', url: '/blog/panneau-solaire-canicule-production', category: 'Blog', badge: '\u00c9t\u00e9' },
